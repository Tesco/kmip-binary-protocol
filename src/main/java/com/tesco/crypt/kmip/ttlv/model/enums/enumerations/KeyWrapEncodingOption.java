...
public enum KeyWrapEncodingOption implements ByteEnum<KeyWrapEncodingOption> {
    NO_ENCODING("1"),
    TTLV_ENCODING("2"),
    EXTENSIONS("8XXXXXXX");
    ...
    KeyWrapEncodingOption(String hexValue) {
    ...
    @Override
    public Class<KeyWrapEncodingOption> getType() {
