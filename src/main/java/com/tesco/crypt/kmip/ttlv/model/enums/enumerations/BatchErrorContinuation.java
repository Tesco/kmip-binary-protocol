...
public enum BatchErrorContinuation implements ByteEnum<BatchErrorContinuation> {
    CONTINUE("1"),
    STOP("2"),
    UNDO("3"),
    EXTENSIONS("8XXXXXXX");
    ...
    BatchErrorContinuation(String hexValue) {
    ...
    @Override
    public Class<BatchErrorContinuation> getType() {
